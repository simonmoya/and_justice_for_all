...
define([ "jquery","backbone","models/CategoryModel" ], function( $, Backbone, CategoryModel ) {
    ...
    var Collection = Backbone.Collection.extend( {
        ...
        jsonArray: [
            ...
            { "category": "animals", "type": "Mascotas" },

            { "category": "animals", "type": "Animales de Granja" },

            { "category": "animals", "type": "Animales Salvajes" },

            { "category": "colors", "type": "Azul" },

            { "category": "colors", "type": "Verde" },
