function busca_tabla($objTabla,strCadena)
{
...
//hacemos la busqueda en el evento search del control de busqueda
	$('#busqueda').on('search',function(){
//	$('#busqueda').bind( "search", function(){
		//le decimos a la funcion que busque en la tabla tblTabla el
		//valor que contiene el campo actual
		$.fntBuscarEnTabla(document.getElementById('busqueda').value,'tblTabla');
	});
});